...
import { Calendar, MapPin, Users, Share2, Tag, ArrowLeft, Ticket } from "lucide-react";
...
export default function EventDetailPage({
  ...
  return (
    <div className="bg-background min-h-screen pb-24">
      <div className="relative h-[40vh] min-h-[280px] w-full bg-muted/20">
        <Image
          ...
          <div className="lg:w-2/3 space-y-8">
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-border shadow-sm">
              ...
              <div className="flex items-center gap-4 py-6 border-y border-border my-6">
                <div className="relative w-12 h-12 rounded-full border-2 border-white bg-primary/10 overflow-hidden shrink-0 shadow-sm">
                  <Image
                ...
                <div className="mt-8 pt-6 border-t border-border">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {event.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 bg-card border border-border rounded-lg text-sm text-muted"
                      >
                        {tag}
                      </span>
                    ))}
