      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="pt-4 border-t border-border mt-auto flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            <div className="relative w-8 h-8 rounded-full border border-border bg-primary/10 overflow-hidden shrink-0">
              <Image
          ...
          <div className="flex items-center gap-1 text-sm font-medium text-primary bg-primary/5 px-3 py-1.5 rounded-lg group-hover:bg-primary group-hover:text-white transition-colors shrink-0">
            <span>View</span>
