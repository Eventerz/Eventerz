...
export default function FeaturedEvents() {
  const featuredEvents = MOCK_EVENTS.filter((event) => event.isFeatured).slice(
    0,
    3
  );
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="pt-4 border-t border-border mt-auto flex items-center justify-between">
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="relative w-8 h-8 rounded-full border-2 border-white bg-primary/10 overflow-hidden shrink-0">
                      <Image
                    ...
                    <span className="text-sm font-medium text-foreground ml-1 truncate">
                      By {event.organizer.displayName}
                    </span>
                  </div>

                  <div className="flex items-center gap-1.5 text-sm font-medium text-muted bg-card px-2.5 py-1 rounded-md shrink-0">
