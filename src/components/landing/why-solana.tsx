        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          <div className="lg:w-1/3">
            ...
            <p className="text-lg text-muted mb-8 leading-relaxed">
              We chose Solana because events happen in real-time. You shouldn't have to wait minutes or pay high fees just to RSVP or check in.
            </p>
          ...
          <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {SOLANA_ADVANTAGES.map((advantage, idx) => (
              ...
              >
                ...
                <p className="text-muted leading-relaxed">{advantage.description}</p>
              </div>
            ))}
          </div>
